...
export const FORM_STYLES = {
	...
	// Container styles
	container: {
		wrapper: 'relative mt-50 sm:pt-20 md:pt-36 w-full max-w-5xl s',
		panel:
			'relative bg-[#E2EEE2] translate-y-0 rounded-2xl md:rounded-[32px] overflow-hidden shadow-2xl flex flex-col md:flex-row min-h-[950px] h-auto items-center justify-center md:justify-start',
		background:
