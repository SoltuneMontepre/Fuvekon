...
const InfoSection = ({ prefersReducedMotion = false }: InfoSectionProps) => {
	...
	return (
		...
		>
			...
			<div className='absolute inset-0 bg-gradient-to-r from-slate-950/75 via-slate-900/65 to-slate-950/50 pointer-events-none' />
			...
			<div className='relative h-full flex items-center justify-center px-8 md:px-20'>
				<div className='grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 w-full max-w-6xl items-center'>
						...
						<div className='flex flex-col gap-5'>
							...
							<div className='info-detail flex items-start gap-4'>
								...
								<div>
									...
									<p className='text-text/75 text-sm mt-0.5'>{t('address')}</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div className='flex flex-col gap-4'>
						{/* Primary large image */}
						<div className='info-image relative h-56 md:h-64 rounded-2xl overflow-hidden shadow-2xl ring-1 ring-white/10'>
							<Image
								src='/images/landing/venue-1.png'
								alt={t('venue')}
								fill
						...
						<div className='flex gap-4'>
							<div className='info-image relative flex-1 h-40 md:h-44 rounded-2xl overflow-hidden shadow-xl ring-1 ring-white/10'>
								<Image
									src='/images/landing/venue-2.png'
									alt={t('venue')}
									fill
									className='object-cover'
								/>
							...
							<div className='info-image relative flex-1 h-40 md:h-44 rounded-2xl overflow-hidden shadow-xl ring-1 ring-white/10'>
								<Image
									src='/images/landing/venue-3.png'
									alt={t('venue')}
									fill
									className='object-cover'
								/>
