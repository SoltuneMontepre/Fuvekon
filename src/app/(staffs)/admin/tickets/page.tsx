		...
		<div id='ticket-management-page' className='ticket-management-page w-full'>
			...
			{showCreateForm && (
				<div className='bg-white rounded-lg shadow-sm border p-4 mb-6'>
					<h3 className='font-semibold text-[#154c5b] mb-2'>
						{t('createTicketTitle')}
					</h3>
					...
					<div className='flex flex-wrap gap-4 items-end'>
						<div className='flex-1 min-w-[200px]'>
							...
							<input
								...
								className='w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#7cbc97] dark:bg-gray-800 dark:border-gray-600'
							/>
						</div>
			...
			{/* Create Tier Form */}
			{showCreateTierForm && (
				<div className='bg-white rounded-lg shadow-sm border p-4 mb-6 dark:bg-gray-900 dark:border-gray-700'>
					...
					<div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
						...
						<div className='md:col-span-2'>
							...
							<textarea
								...
								rows={3}
								className='w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#7cbc97] dark:bg-gray-800 dark:border-gray-600 resize-none'
							/>
						</div>
						<div className='md:col-span-2'>
							<button
			...
			<div className='bg-white rounded-lg shadow-sm border overflow-hidden mb-6 dark:bg-gray-900 dark:border-gray-700'>
				<h3 className='font-semibold text-[#154c5b] dark:text-dark-text px-4 py-3 border-b dark:border-gray-700'>
					{t('manageTiers')}
				</h3>
				{adminTiers.length === 0 ? (
			...
			{!statsLoading && stats && (
				<div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-6'>
					<div className='bg-white rounded-lg p-4 shadow-sm border'>
						...
						<p className='text-2xl font-bold text-[#154c5b]'>
							{stats.total_tickets}
						</p>
					</div>
			...
			{editTierModal && (
				<div className='fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4'>
					<div className='bg-white dark:bg-gray-900 rounded-xl p-6 max-w-lg w-full shadow-2xl max-h-[90vh] overflow-y-auto'>
						...
						<div className='flex gap-3 mt-6'>
							<button
								...
								className='flex-1 py-2 px-4 rounded-lg border border-gray-500 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'
							>
								{tCommon('cancel')}
							</button>
							<button
